...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-21 23:31:26 UTC<br>状态：成功</p>
</section>
...
<p>今日共生成 15 篇推荐（精读 8 篇，速读 7 篇）</p>
<p>精读：《TacBPM: A Tactile-conditioned Behavior Prior Model for Dexterous Reorientation》（8.0/10）, 《ForwardDLO: Model-Based Bimanual Shape Matching of Unconstrained Deformable Linear Objects》（8.0/10）</p>
<p>速读：《Dreaming the Sound of Contact: Leveraging Video and Audio Generation for Zero-Shot Force-Aware Manipulation and Data Generation》（8.0/10）, 《ULOHA: An Underwater Bimanual Robot System for Robot Learning》（8.0/10）, 《GR2PO: Group Relative Return Policy Optimization for Continuous Robot Control》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="TacBPM: A Tactile-conditioned Behavior Prior Model for Dexterous Reorientation">TacBPM: A Tactile-conditioned Behavior Prior Model for Dexterous Reorientation</span></li><li><span class="dpr-home-dashboard-paper-title" title="ForwardDLO: Model-Based Bimanual Shape Matching of Unconstrained Deformable Linear Objects">ForwardDLO: Model-Based Bimanual Shape Matching of Unconstrained Deformable Linear Objects</span></li><li><span class="dpr-home-dashboard-paper-title" title="CSWAM: Better Causal Semantic Representations for Out-of-Distribution Generalization in World Action Models">CSWAM: Better Causal Semantic Representations for Out-of-Distribution Generalization in World Action Models</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">robot-learn <strong>3</strong></span><span class="dpr-home-dashboard-tag">world-model <strong>3</strong></span><span class="dpr-home-dashboard-tag">control <strong>2</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Dreaming the Sound of Contact: Leveraging Video and Audio Generation for Zero-Shot Force-Aware Manipulation and Data Generation">Dreaming the Sound of Contact: Leveraging Video and Audio Generation for Zero-Shot Force-Aware Manipulation and Data Generation</span></li><li><span class="dpr-home-dashboard-paper-title" title="ULOHA: An Underwater Bimanual Robot System for Robot Learning">ULOHA: An Underwater Bimanual Robot System for Robot Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="GR2PO: Group Relative Return Policy Optimization for Continuous Robot Control">GR2PO: Group Relative Return Policy Optimization for Continuous Robot Control</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">robot-learn <strong>6</strong></span><span class="dpr-home-dashboard-tag">world-model <strong>1</strong></span></div>
</section>
</div>
